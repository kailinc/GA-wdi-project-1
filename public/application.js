...
/***/ (function(module, exports, __webpack_require__) {
	...
	var boardEvents = __webpack_require__(11);
	...
	$(function () {
	  ...
	  $('.userForms').on('submit', userEvents.onClearForm);
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  userApi.changePwd(data).then(userUi.onChangeSuccess).catch(userUi.onChangeError);
	};
	...
	var onClearForm = function onClearForm(event) {
	  event.preventDefault();
	  $('.formText').val('');
	};
	module.exports = {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(16);
	var gameReg = __webpack_require__(17);
	var statsInfo = __webpack_require__(15);

	var onStartGame = function onStartGame(e) {
	  e.preventDefault();
	  boardReady();
	  gameApi.create().then(gameUi.createGameSuccess).catch(gameUi.createGameError);
	  // prevent game from ending, game must continue until tie or wins
	  gameReg.gameOperation(0);
	};

	var onCheckStats = function onCheckStats(e) {
	  e.preventDefault();
	  gameApi.index().then(gameUi.checkStatsSuccess).catch(gameUi.checkStatsError);
	};

	var boardReady = function boardReady() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(9);
	var config = __webpack_require__(6);
	var gameInfo = __webpack_require__(13);
	...
	var update = function update(position, player, status) {
	  // console.log(data)
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameOverSuccess = function gameOverSuccess(data) {
	  // console.log(gameInfo.name)
	  // console.log(data)
	  gameInfo.game = null;
	};

	var gameOverError = function gameOverError(error) {
	  console.log(error);
	};

	var gameContinueSuccess = function gameContinueSuccess(data) {
	  // console.log(data)
	};
	var gameContinueError = function gameContinueError() {
	  // console.log(error)
	};

	var checkStatsSuccess = function checkStatsSuccess(data) {
	...
	var checkStatsError = function checkStatsError(error) {
	  console.log(error);
	};
	...
	var checkWin = function checkWin(array) {
	...
	var checkX = function checkX(string) {
	  return string === 'x';
	};
	...
	module.exports = {
	  ...
	  gameContinueError: gameContinueError,
	  gameContinueSuccess: gameContinueSuccess,
	  checkStatsError: checkStatsError,
	  checkStatsSuccess: checkStatsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameOperation = function gameOperation(turns) {
	...
	var addSpot = function addSpot() {
	  ...
	  if (spot.text() === '-' && localTurns % 2 === 0) {
	    ...
	    if (checkWinTie(x) === true) {
	      ...
	      gameApi.update(index, x, true).then(gameUi.gameOverSuccess).catch(gameUi.gameOverError);
	      if (checkWin(x) === true) {
	        updateHeadline(x);
	        $('#board li').text(x);
	        addWin(x);
	      ...
	      var _index = $(this).attr('id') - 1;
	      gameApi.update(_index, x, false).then(gameUi.gameContinueSuccess).catch(gameUi.gameContinueError);
	    }
	  } else if (spot.text() === '-' && localTurns % 2 === 1) {
	    spot.text(o).addClass('o');
	    localTurns += 1;
	    if (checkWinTie(o) === true) {
	      var _index2 = $(this).attr('id') - 1;
	      gameApi.update(_index2, o, true).then(gameUi.gameOverSuccess).catch(gameUi.gameOverError);
	      if (checkWin(o) === true) {
	        updateHeadline(o);
	        $('#board li').text(o);
	        addWin(o);
	      ...
	      var _index3 = $(this).attr('id') - 1;
	      gameApi.update(_index3, o, false).then(gameUi.gameContinueSuccess).catch(gameUi.gameContinueError);
	    }
	  }
	};

	var checkWinTie = function checkWinTie(player) {
	  if (spot1.hasClass(player) && spot2.hasClass(player) && spot3.hasClass(player) || spot4.hasClass(player) && spot5.hasClass(player) && spot6.hasClass(player) || spot7.hasClass(player) && spot8.hasClass(player) && spot9.hasClass(player) || spot1.hasClass(player) && spot4.hasClass(player) && spot7.hasClass(player) || spot2.hasClass(player) && spot5.hasClass(player) && spot8.hasClass(player) || spot3.hasClass(player) && spot6.hasClass(player) && spot9.hasClass(player) || spot1.hasClass(player) && spot5.hasClass(player) && spot9.hasClass(player) || spot3.hasClass(player) && spot5.hasClass(player) && spot7.hasClass(player)) {
	    return true;
	...
	var addWin = function addWin(player) {
	  var win = parseInt($('#' + player).text());
	  win += 1;
	  $('#' + player).text(win);
	};

	var updateHeadline = function updateHeadline(player) {
